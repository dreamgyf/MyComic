package com.dreamgyf.mycomic.view;
 ...
 * 手势图片控件
 *
 * @author clifford https://github.com/boycy815/PinchImageView
 */
public class ScaleImageView extends AppCompatImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == ScaleImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(ScaleImageView scaleImageView);
    }
    ...
    @Override
    public void setScaleType(ScaleType scaleType) {super.setScaleType(scaleType);}
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(ScaleImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
